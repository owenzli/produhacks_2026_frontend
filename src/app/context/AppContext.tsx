...
export type RoleTemplate =
  // Engineering
  | 'frontend' | 'backend' | 'fullstack' | 'devops' | 'engineering-manager'
  // Product
...
export function generateRoadmapTasks(info: HireInfo): Task[] {
  switch (info.template) {
    ...
    default: return generateFrontendTasks(info.startDate);
  }
}
